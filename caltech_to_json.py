...
if __name__ == '__main__':
    ...
    caltech_root = '/home/tianliang/SSAP2/Cloud/Caffe2_projects/detectron/lib/' \
                   'datasets/data/pedestrian_datasets/data-USA'
    image_set = 'train'
    ...
    # f = open('/home/tianliang/SSAP2/Cloud/Caffe2_projects/detectron/lib/datasets/data/'
    #          'pedestrian_datasets/data-USA/json_annotations/caltech_trainval.json', 'w')
    ...
    f = open('/home/tianliang/SSAP2/Cloud/Caffe2_projects/detectron/lib/datasets/data/'
             'pedestrian_datasets/data-USA/json_annotations/caltech_test.json', 'w')
